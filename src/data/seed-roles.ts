...
export const roles: Role[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'po.view', 'po.export', 'po.close',
      'grn.view', 'grn.export',
      'payments.view', 'payments.export',
      ...read('transfers'),
      ...read('invoices', 'receipts'), 'invoices.void', 'finance.view',
  ...
  },
  {
    ...
    permissions: [
      ...
      'pr.view', 'pr.export',
      ...read('po', 'grn', 'transfers'),
      'invoices.view', 'invoices.export', 'finance.view',
  ...
  },
  {
    ...
    permissions: [
      ...
      'divisions.view', 'suppliers.view', 'suppliers.export',
      'mr.view', 'mr.submit', 'pr.view', 'pr.export',
      'po.view', 'po.export', 'grn.view', 'grn.export',
      ...all('payments'),
      ...all('invoices', 'receipts', 'finance'),
      'transfers.view', 'transfers.export',
